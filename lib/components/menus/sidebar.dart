...
class NavBar extends StatefulWidget {
  //bool _menuDataFetched = false;
static var menudata =false;
  NavBar(bool loadmenu)
  {
    menudata= loadmenu;
  }
  @override
...
class _NavBarState extends State<NavBar> {
  ...
  _NavBarState()
  {
    _menuDataFetched=NavBar.menudata;
    print("_menuDataFetched$_menuDataFetched");
  }
  ...
  _loadMenuDataNeeded() async {
    if (_menuDataFetched) {
      await _fetchMenuData();
      _menuDataFetched = false;
      isLoading=false;
    } else {
      setState(() {
        isLoading = false;
  ...
  _fetchMenuData() async {
    print("_menuDataFetchedingetapi$_menuDataFetched");
    SharedPreferences prefs = await SharedPreferences.getInstance();
